...
BLOCKED_CELLS = [(60, 10), (50, 10), (40, 10), (30, 10), (20, 10), (70, 10), (80, 10), (90, 10), (100, 10), (100, 20),
                 ...
                 (300, 210), (300, 220), (300, 230), (300, 240), (300, 250), (360, 340), (370, 340), (380, 340),
                 (390, 340),
                 (170, 140), (180, 140), (190, 140), (200, 140), (210, 140), (220, 140), (230, 140), (240, 140),
                 (250, 140), (260, 140), (270, 140), (280, 140), (290, 140),
                 (100, 340), (110, 340), (120, 340), (130, 340), (140, 340), (150, 340), (160, 340), (170, 340),
                 (180, 340), (190, 340), (200, 340), (210, 340), (220, 340),
                 (230, 340), (240, 340), (250, 340), (260, 340), (270, 340), (280, 340), (290, 340), (300, 340),
...
def get_adjacent_node(node, END):
    ...
    for dir in DIRECTIONS:
        ...
        if 0 <= new_pos[0] <= 390 and 0 <= new_pos[1] <= 390:
            list_of_node.append(Node(new_pos, node.current_pos, node.g + 1, heuristic_cost(new_pos, END)))
...
def main(start_pos, END):
    open_set = {str(start_pos): Node(start_pos, start_pos, 0, heuristic_cost(start_pos, END))}
    closed_set = {}
...
while running:
    ...
    if dest:
        for e in END_LIST:
            pygame.draw.rect(screen, (0, 255, 0), [e[0], e[1], 10, 10])
